    ...
    private void loadSprites() {
        ...
        try {
            ...
            BufferedImage[] sprites = new BufferedImage[] {
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_idle.png")),
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_walk.png")),
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_run.png")),
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_jump.png")),
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_climb.png")),
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_attack1.png")),
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_hurt.png")),
                    ImageIO.read(new File("src/main/resources/characters/main_characters/woodcutter/Woodcutter_death.png"))
            };
