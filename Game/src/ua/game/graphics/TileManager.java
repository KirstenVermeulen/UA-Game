...
public class TileManager {
    ...
    public TileManager(J2DContext j2dContext) {
        ...
        loadImages();
        loadMap("src/resource/maps/level1Map.txt");
    }
    ...
    private void loadImages() {
        try {
            ...
            background = ImageIO.read(new File("src/resource/green_zone/background/day/Background.png"));
            ...
            for (int i = 0; i <= 96; i++) {
                ...
                if (i < 10) {
                    path = String.format("src/resource/green_zone/tiles/Tile_0%d.png", i);
                } else {
                    path = String.format("src/resource/green_zone/tiles/Tile_%d.png", i);
                }
